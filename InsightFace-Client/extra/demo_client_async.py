...
if __name__ == "__main__":
    ...
    def write_results(results):
        ...
        for file, face in zip(files, features):
            print(f"File: {file}, Face: {face[:5]}")
    ...
    with multiprocessing.Pool(processes=args.threads) as pool:
        ...
        arguments = (
            {
                "data": batch,
                "extract_embedding": to_bool(args.embed),
                "embed_only": to_bool(args.embed_only),
                "mode": mode,
                "limit_faces": 0
            }
